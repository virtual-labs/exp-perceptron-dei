...
function downloadExperiment() {
    ...
    link.href = './assets/Exp-1_Perceptron.pdf';
...
async function executeCell(cellNumber) {
    ...
    // Enable download button when all cells are completed
    if (state.completedSteps.size === CONFIG.totalSteps && elements.downloadBtn) {
